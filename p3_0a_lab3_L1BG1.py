...
from bloqueQAM import bloqueQAM  # grc-generated hier_block
...
class p3_0a_lab3_L1BG1(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Transmisor AM")
        ...
        self.settings = Qt.QSettings("GNU Radio", "p3_0a_lab3_L1BG1")
        ...
        # Connections
        ##################################################
        self.connect((self.analog_sig_source_x_0, 0), (self.bloqueQAM_0, 0))
        self.connect((self.analog_sig_source_x_0, 0), (self.bloqueQAM_0, 1))
        self.connect((self.bloqueQAM_0, 0), (self.uhd_usrp_sink_0, 0))
...
def main(top_block_cls=p3_0a_lab3_L1BG1, options=None):
